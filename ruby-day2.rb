...
# The Tree class was interesting, but it did not allow you to specify a new tree with 
# a clean user interface. Let the initializer accept a nested structure with hashes and arrays. 
...
# anywhere in that line. you will need to do a simple regular expression match and read lines from a file. 
